...
echo '<thead><tr><th>Venta ID</th><th>Nombre Repuesto</th><th>Cantidad Vendida</th><th>Cliente</th><th>Fecha Venta</th><th>Total</th><th>Acciones</th></tr></thead>';
echo '<tbody>';
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    echo '<td>';
    echo '<a href="../php/vta/modificar_venta.php?id=' . $fila['VentaID'] . '" class="btn btn-warning btn-sm">Modificar</a> ';
    echo '<a href="../php/vta/eliminar_venta.php?id=' . $fila['VentaID'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'¿Estás seguro de que deseas eliminar esta venta?\');">Eliminar</a>';
    echo '</td>';
    echo '</tr>';
}
